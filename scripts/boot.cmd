...
setenv bootargs "${bootargs_base} root=fstab rw atomicnix.lowerdev=/dev/mmcblk1p${distro_rootpart} atomicnix.lowerfstype=squashfs init=@systemClosure@/init rauc.slot=${rauc_slot}"
