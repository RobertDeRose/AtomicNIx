...
nixos-lib.runTest {
  ...
  testScript = ''
    ...
    gateway.succeed("env PATH=/testbin:/run/current-system/sw/bin ATOMICNIX_CONFIG_ROOT=/tmp/config-roots/fresh-boot-seed ATOMICNIX_FIRST_BOOT_SENTINEL=/tmp/bootcases/fresh-boot-seed/sentinel ATOMICNIX_FORENSICS_RAUC_STATE_DIR=/tmp/bootcases/fresh-boot-seed/forensics ATOMICNIX_BOOT_SLOT=boot.a ATOMICNIX_USB_SEARCH_DIRS='/test-usb' ATOMICNIX_BOOTSTRAP_HOST=127.0.0.1 ATOMICNIX_BOOTSTRAP_PORT=18080 ATOMICNIX_INITRD_MARKER=/etc/atomicnix/fresh-flash ATOMICNIX_BOOT_CONFIG_PATH=/boot/config.toml first-boot")
    ...
    gateway.succeed("env PATH=/testbin:/run/current-system/sw/bin ATOMICNIX_CONFIG_ROOT=/tmp/config-roots/fresh-usb-fallback ATOMICNIX_FIRST_BOOT_SENTINEL=/tmp/bootcases/fresh-usb-fallback/sentinel ATOMICNIX_FORENSICS_RAUC_STATE_DIR=/tmp/bootcases/fresh-usb-fallback/forensics ATOMICNIX_BOOT_SLOT=boot.a ATOMICNIX_USB_SEARCH_DIRS='/test-usb' ATOMICNIX_BOOTSTRAP_HOST=127.0.0.1 ATOMICNIX_BOOTSTRAP_PORT=18080 ATOMICNIX_INITRD_MARKER=/etc/atomicnix/fresh-flash ATOMICNIX_BOOT_CONFIG_PATH=/boot/config.toml first-boot")
    ...
    gateway.succeed("env PATH=/testbin:/run/current-system/sw/bin ATOMICNIX_CONFIG_ROOT=/tmp/config-roots/reprovision-skips-boot ATOMICNIX_FIRST_BOOT_SENTINEL=/tmp/bootcases/reprovision-skips-boot/sentinel ATOMICNIX_FORENSICS_RAUC_STATE_DIR=/tmp/bootcases/reprovision-skips-boot/forensics ATOMICNIX_BOOT_SLOT=boot.a ATOMICNIX_USB_SEARCH_DIRS='/test-usb' ATOMICNIX_BOOTSTRAP_HOST=127.0.0.1 ATOMICNIX_BOOTSTRAP_PORT=18080 ATOMICNIX_INITRD_MARKER=/etc/atomicnix/fresh-flash ATOMICNIX_BOOT_CONFIG_PATH=/boot/config.toml first-boot")
    ...
    gateway.succeed("rm -rf /test-usb/usb-a/* /test-usb/usb-b/*")
    gateway.succeed("ATOMICNIX_CONFIG_ROOT=/tmp/bootstrap-root ATOMICNIX_FIRST_BOOT_SENTINEL=/tmp/bootstrap-sentinel ATOMICNIX_FORENSICS_RAUC_STATE_DIR=/tmp/bootstrap-forensics ATOMICNIX_BOOT_SLOT=boot.a ATOMICNIX_USB_SEARCH_DIRS='/test-usb' ATOMICNIX_BOOTSTRAP_PORT=18080 ATOMICNIX_BOOTSTRAP_DOWNLOAD_GRACE_SECONDS=3 PATH=/testbin:/run/current-system/sw/bin first-boot >/tmp/bootstrap-case.log 2>&1 & echo $! >/tmp/bootstrap-case.pid")
    ...
    gateway.fail("env PATH=/testbin:/run/current-system/sw/bin ATOMICNIX_CONFIG_ROOT=/tmp/prod-missing-root ATOMICNIX_FIRST_BOOT_SENTINEL=/tmp/prod-missing-sentinel ATOMICNIX_FORENSICS_RAUC_STATE_DIR=/tmp/prod-missing-forensics ATOMICNIX_BOOT_SLOT=boot.a ATOMICNIX_USB_SEARCH_DIRS='/test-usb' ATOMICNIX_BOOTSTRAP_HOST=127.0.0.1 ATOMICNIX_BOOTSTRAP_PORT=18080 first-boot")
    ...
    gateway.succeed("env PATH=/testbin:/run/current-system/sw/bin ATOMICNIX_CONFIG_ROOT=/tmp/dev-fallback-root ATOMICNIX_FIRST_BOOT_SENTINEL=/tmp/dev-fallback-sentinel ATOMICNIX_FORENSICS_RAUC_STATE_DIR=/tmp/dev-fallback-forensics ATOMICNIX_BOOT_SLOT=boot.a ATOMICNIX_USB_SEARCH_DIRS='/test-usb' ATOMICNIX_BOOTSTRAP_HOST=127.0.0.1 ATOMICNIX_BOOTSTRAP_PORT=18080 ATOMICNIX_DEV_ENABLE_SSH_WAN=1 first-boot")
